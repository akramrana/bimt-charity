...
var app = {
    ...
    sendPushNotification(userId) {
        ...
        if (!confirm("Send this push notification?")) {
            return;
        }
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    alert(response.message || "Push notification sent successfully.");
                } else {
                    alert(response.message || "Failed to send push notification.");
                }
            },
            error: function (xhr) {
                let message = "Failed to send push notification.";
