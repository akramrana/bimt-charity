...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <p>
            ...
            <?= ($allowGenerate) ? Html::a('Send mail to All', ['send-mail-to-all'], ['class' => 'btn btn-warning pull-right', 'style' => 'margin-right: 5px;', 'onclick' => 'return confirm("Are you sure want to send email to all user?")']) : "" ?>
        </p>
